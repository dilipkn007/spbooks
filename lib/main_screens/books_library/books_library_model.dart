...
class BooksLibraryModel extends FlutterFlowModel<BooksLibraryWidget> {
  ...
  late FlutterFlowDynamicModels<BookCardModel> bookCardModels1;
  // Models for book_card dynamic component.
  late FlutterFlowDynamicModels<BookCardModel> bookCardModels2;
  // Models for book_card dynamic component.
  late FlutterFlowDynamicModels<BookCardModel> bookCardModels3;
  // Models for book_card dynamic component.
  late FlutterFlowDynamicModels<BookCardModel> bookCardModels4;
  // Model for section_header component.
  ...
  void initState(BuildContext context) {
    ...
    bookCardModels1 = FlutterFlowDynamicModels(() => BookCardModel());
    bookCardModels2 = FlutterFlowDynamicModels(() => BookCardModel());
    bookCardModels3 = FlutterFlowDynamicModels(() => BookCardModel());
    bookCardModels4 = FlutterFlowDynamicModels(() => BookCardModel());
  ...
  void dispose() {
    ...
    bookCardModels1.dispose();
    bookCardModels2.dispose();
    bookCardModels3.dispose();
    bookCardModels4.dispose();
