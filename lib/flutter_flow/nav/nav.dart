...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) => ReaderViewWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          builder: (context, _) => ReaderViewWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
            ...
            path: BooksLibraryWidget.routePath,
            builder: (context, params) => params.isEmpty
                ? NavBarPage(initialPage: 'BooksLibrary')
                : NavBarPage(
                    initialPage: 'BooksLibrary',
                    page: BooksLibraryWidget(),
                  )),
        FFRoute(
        ...
        FFRoute(
            name: PowerSearchWidget.routeName,
            path: PowerSearchWidget.routePath,
            builder: (context, params) => params.isEmpty
